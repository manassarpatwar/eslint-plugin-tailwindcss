...
module.exports = {
  ...
  create: function (context) {
    ...
    const skipProperties = getOption(context, 'skipProperties');
     ...
     * @param {ASTNode} node
     * @param {ASTNode} childNode
     */
    const parseForCustomClassNames = (classNames, node, childNode) => {
    ...
    const callExpressionVisitor = function (node) {
      ...
      node.arguments.forEach((arg) => {
        astUtil.parseNodeRecursive(node, arg, parseForCustomClassNames, false, false, skipProperties);
      });
    };
